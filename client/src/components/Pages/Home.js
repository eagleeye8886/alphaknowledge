          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6 text-center lg:text-left">
                ...
                <div 
                  className="relative bg-white/80 backdrop-blur-sm border border-gray-200 shadow-lg dark:bg-white/10 dark:backdrop-blur-xl dark:border-white/20 dark:shadow-2xl rounded-2xl p-6"
                  data-aos="fade-up"
            ...
            {/* Statistics - Updated for Light Theme */}
            {/* <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {statsData.map((stat, index) => (
                <div key={index} data-aos={stat.animation} data-aos-duration="1300" className="relative group">
                  <div className="relative z-10 bg-white/80 dark:bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-gray-200 dark:border-white/20 overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl h-full flex flex-col justify-between shadow-lg dark:shadow-none">
                    <div className={`absolute -z-10 inset-0 bg-gradient-to-br ${stat.color} opacity-5 dark:opacity-10 group-hover:opacity-10 dark:group-hover:opacity-20 transition-opacity duration-300`}></div>
                    
                    <div className="flex items-center justify-between mb-4">
                      <div className="w-16 h-16 rounded-full flex items-center justify-center bg-gray-100 dark:bg-white/10 transition-transform group-hover:rotate-6">
                        <stat.icon className="w-8 h-8 text-[#6366f1] dark:text-white" />
                      </div>
                      <span className="text-4xl font-bold text-gray-800 dark:text-white" data-aos="fade-up-left" data-aos-duration="1500">
                        {stat.value}
                      </span>
                    </div>
                    <div>
                      <p className="text-sm uppercase tracking-wider text-gray-600 dark:text-gray-300 mb-2" data-aos="fade-up" data-aos-duration="800">
                        {stat.label}
                      </p>
                      <div className="flex items-center justify-between">
                        <p className="text-xs text-gray-500 dark:text-gray-400" data-aos="fade-up" data-aos-duration="1000">
                          {stat.description}
                        </p>
                        <ArrowUpRight className="w-4 h-4 text-gray-400 dark:text-white/50 group-hover:text-[#6366f1] dark:group-hover:text-white transition-colors" />
                      </div>
                    </div>
                  </div>
                </div>
